                ...
                <div class="mainrow row">
                    ...
                    <div class="subsection col-sm-12 col-md-6">
                        <a href="subsection.php?nazwa_podrozdzialu=Lore">
                            <div class="block row border border-light">
                                <div class="figure col-3">
                                    <img src="Lore.jpg" class="figureimg border border-dark" alt="">
                                </div>
                                <div class="blocksection col-9">
                                    <div class="row">
                                        <div class="chapter col-12">
                ...
                <div class="mainrow row">
                    <div class="subsection col-sm-12 col-md-6">
                        <a href="subsection.php?nazwa_podrozdzialu=GuildRecruitment">
                            <div class="block row border border-light">
                                <div class="figure col-3">
                                    <img src="Recruitment.jpg" class="figureimg border border-dark" alt="">
                                </div>
                                <div class="blocksection col-9">
                                    <div class="row">
                                        <div class="chapter col-12">
                    ...
                    <div class="subsection col-sm-12 col-md-6">
                        <a href="subsection.php?nazwa_podrozdzialu=Tavern">
                            <div class="block row border border-light">
                                <div class="figure col-3">
                                    <img src="Tavern.jpg" class="figureimg border border-dark" alt="">
                                </div>
                                <div class="blocksection col-9">
                                    <div class="row">
                                        <div class="chapter col-12">
                ...
                <div class="mainrow row">
                    <div class="subsection col-sm-12 col-md-6">
                        <a href="subsection.php?nazwa_podrozdzialu=New Player Zone">
                            <div class="block row border border-light">
                                <div class="figure col-3">
                                    <img src="NewPlayerZone.jpg" class="figureimg border border-dark" alt="">
                                </div>
                                <div class="blocksection col-9">
                                    <div class="row">
                                        <div class="chapter col-12">
                    ...
                    <div class="subsection col-sm-12 col-md-6">
                        <a href="subsection.php?nazwa_podrozdzialu=Professions">
                            <div class="block row border border-light">
                                <div class="figure col-3">
                                    <img src="Professions.jpg" class="figureimg border border-dark" alt="">
                                </div>
                                <div class="blocksection col-9">
                                    <div class="row">
                                        <div class="chapter col-12">
                ...
                <div class="mainrow row">
                    <div class="subsection col-sm-12 col-md-6">
                        <a href="subsection.php?nazwa_podrozdzialu=Achievements">
                            <div class="block row border border-light">
                                <div class="figure col-3">
                                    <img src="Achievements.jpg" class="figureimg border border-dark" alt="">
                                </div>
                                <div class="blocksection col-9">
                                    <div class="row">
                                        <div class="chapter col-12">
                    ...
                    <div class="subsection col-sm-12 col-md-6">
                        <a href="subsection.php?nazwa_podrozdzialu=Classes">
                            <div class="block row border border-light">
                                <div class="figure col-3">
                                    <img src="Classes.jpg" class="figureimg border border-dark" alt="">
                                </div>
                                <div class="blocksection col-9">
                                    <div class="row">
                                        <div class="chapter col-12">
